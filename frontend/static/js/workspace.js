...
(function () {
  ...
  function openGenericViewTab(renderer, scopeQuery, scopeLabel) {
    ...
    var labels = { table: 'Table View', card: 'Cards View', graph: 'Graph View', 'graph-3d': '3D Graph View', kanban: 'Kanban View', calendar: 'Calendar View', map: 'Map View', timeline: 'Timeline View' };
