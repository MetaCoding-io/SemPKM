...
- R001 [non-functional] — Lazy-load non-object-contextual panels (owner: M049/S03)

### Future Candidates

See `.gsd/QUEUE.md` for the full milestone queue. Next up: M049 (Backend Performance & Observability), M050 (View System Rework).
