...
**Current milestone:** M005 Platform Polish & Foundation — S01 (Query SQL→RDF) ✅, S02 (Operations Log & PROV-O) ✅, S03 (Hierarchical Tag Tree) ✅, S04 (Tag Autocomplete) ✅, S05 (Model Schema Refresh) ✅. See `.gsd/milestones/M005/M005-ROADMAP.md` for remaining slices (S06-S09).
