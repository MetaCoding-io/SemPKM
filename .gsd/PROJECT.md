...
**Last completed milestone:** M055 — Browser History & Tab Recovery (2026-04-06)
...
Replaced the flat OBJECTS explorer dropdown with a composable filter/group/sort engine. Server-side persistence, multi-panel OBJECTS sections, and preset configs. 66 tests pass. Requirements R011-R013 validated.
