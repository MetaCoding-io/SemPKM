...
- [ ] **T01: Object & edge deletion tests** `est:1h`
...
- [ ] **T02: Event undo & event log detail tests** `est:45m`
...
- [ ] **T03: Spatial canvas tests — implement all 27 stubs** `est:2h`
...
- [ ] **T04: Bottom-panel SPARQL & SPARQL advanced features tests** `est:1h`
...
- [ ] **T05: Admin model lifecycle & admin detail pages tests** `est:1h`
...
- [ ] **T06: Auth rate limiting & invite flow tests** `est:45m`
...
- [ ] **T07: LLM config, tooltip, edge provenance, health check tests** `est:1h`
...
- [ ] **T08: Federation UI, VFS MountSpec, debug pages tests** `est:1h`
...
- [ ] **T09: Table pagination, graph node click, view filtering tests** `est:45m`
...
- [ ] **T10: Markdown rendering, column prefs, sidebar reorder, docs navigation tests** `est:1h`
...
- [ ] **T11: Lint API, validation endpoints, monitoring config, icons, my-views tests** `est:45m`
...
- [ ] **T12: Final coverage audit & zero-skip verification** `est:30m`
