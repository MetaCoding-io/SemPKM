...
- [ ] **T02: Create Jinja2 asset_url filter with dev/prod mode and unit tests** `est:1h`
...
- [ ] **T03: Replace CDN references in all templates with conditional local/CDN blocks** `est:2h`
...
- [ ] **T04: Multi-stage Dockerfile, nginx config, and Docker integration test** `est:2h`
