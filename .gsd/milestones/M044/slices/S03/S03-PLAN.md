...
- [ ] **T02: Migrate template onclick handlers and inline script globals to SemPKM namespace** `est:2h`
...
- [ ] **T03: Update E2E tests and remove backward-compat shims from JS files** `est:1h30m`
