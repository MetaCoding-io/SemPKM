...
- [x] **T02: Migrate high-volume JS files to apiFetch (workspace, sparql-console, copilot, canvas, auth, federation, vfs-browser)** `est:1h`
...
- [x] **T03: Migrate remaining JS files and all HTML templates to apiFetch** `est:45m`
...
- [x] **T04: Full codebase verification sweep and cleanup** `est:15m`
