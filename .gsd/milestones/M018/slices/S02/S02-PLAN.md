...
- [ ] **T02: Build google-calendar app scaffold, auth module, and gcal client with full unit tests** `est:2h`
...
- [ ] **T03: Build app routes, templates, and connect flow** `est:1h30m`
