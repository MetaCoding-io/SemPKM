...
- [ ] **T01: Fix proxy query-string forwarding + build reader shell, CSS, and reader.js** `est:30m`
...
- [ ] **T02: Build feed sidebar and article list route handlers + templates** `est:35m`
...
- [ ] **T03: Build reading pane + star/read/unsubscribe action handlers + workspace views** `est:30m`
...
- [ ] **T04: Unit tests for all reader UI route handlers** `est:25m`
