...
- [ ] **T01: Create OPML parser pure function with comprehensive tests** `est:30m`
...
- [ ] **T02: Wire OPML import route + template into app with integration tests** `est:45m`
...
- [ ] **T03: Add settings manifest declarations, route, template, and tests** `est:45m`
