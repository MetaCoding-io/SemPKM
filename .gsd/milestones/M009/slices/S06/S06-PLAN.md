...
- [x] **T02: Views explorer app contributions and command palette API** `est:1h`
...
- [x] **T03: Object renderer override dispatch and app renderer template** `est:1h30m`
...
- [x] **T04: Admin renderer assignment management** `est:45m`
