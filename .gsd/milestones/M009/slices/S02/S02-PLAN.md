...
- [x] **T01: JWT token generation and validation** `est:30m`
...
- [x] **T02: SDK package — App class, context, clients, runner** `est:2h`
...
- [x] **T03: Platform proxy, router, and manager updates** `est:1h`
...
- [x] **T04: Integration proof — real subprocess round-trip** `est:45m`
