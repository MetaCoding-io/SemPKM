...
- [ ] **T01: AppManifestSchema Pydantic model + validation tests** `est:1h`
...
- [ ] **T02: SQLAlchemy models + Alembic migration 013 + new deps** `est:30m`
...
- [ ] **T03: AppRegistry + AppManager lifecycle engine** `est:2h`
...
- [ ] **T04: Lifespan integration + auto-start + contract tests** `est:1h`
