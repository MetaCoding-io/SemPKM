"""SSE broadcast manager for real-time Notion scan progress.
...
This is a copy of the Obsidian broadcast module (per D258: same SSE
infrastructure reused for Notion import wizard).
"""
...
class ScanBroadcast:
    ...
    def publish(self, event: SSEEvent) -> None:
        ...
        background thread (e.g. the Notion scanner thread).
        """
        try:
