...
plan: 04
subsystem: ui
tags: [firefox, keyboard-shortcuts, ninja-keys, css, tabs, cards, gap-closure]

# Dependency graph
requires:
  - phase: 13-dark-mode-and-visual-polish
    provides: "Theme token system, tab styling, card views, command palette"
provides:
...
tech-stack:
  added: []
  patterns:
    - "Explicit keydown handler for Ctrl+K alongside hotkeys-js to prevent browser interception"
    - "CDN version pinning for third-party web components"
...
requirements-completed: [DARK-01, WORK-06]
