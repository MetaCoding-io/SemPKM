...
plan: 02
subsystem: ui
tags: [sparql, codemirror6, autocomplete, iri-pills, workspace-panel, esm]

requires:
  - phase: 53-sparql-power-user
    provides: "SPARQL API endpoints (history, saved, vocabulary, enrichment)"
provides:
...
affects: [54-sparql-advanced, frontend-sparql-ui]

tech-stack:
  added: [codemirror-lang-sparql@2]
  patterns: ["ES module lazy-loading via dynamic import() on tab activation", "IRI pill rendering with enrichment metadata", "CM6 autocomplete with custom completion source"]
