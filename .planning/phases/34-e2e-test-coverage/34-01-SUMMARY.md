...
plan: 01
subsystem: testing
tags: [playwright, e2e, sparql, webdav, fts, basic-auth, api-tokens]

requires:
  - phase: 26-vfs-webdav
    provides: WebDAV /dav/ endpoint with wsgidav
  - phase: 29-fts-fuzzy-search
    provides: FTS /api/search endpoint and command palette integration
provides:
...
tech-stack:
  added: []
  patterns:
    - "Custom Playwright fixture for VFS Basic auth (API token creation/cleanup)"
    - "PROPFIND-based file discovery for reliable WebDAV path resolution"
