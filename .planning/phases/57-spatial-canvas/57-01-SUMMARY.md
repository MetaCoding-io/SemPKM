...
plan: 01
subsystem: ui
tags: [canvas, snap-to-grid, keyboard-navigation, svg, spatial]
...
tech-stack:
  added: []
  patterns: [snapToGrid pure function for coordinate alignment, spatial sort for node cycling, active element guard for keyboard handlers]
