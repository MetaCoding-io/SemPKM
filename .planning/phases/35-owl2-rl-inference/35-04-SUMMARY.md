...
plan: 04
subsystem: admin
tags: [owlrl, entailment, admin-ui, htmx, settings, model-management]
...
affects: [inference-panel, model-management, admin-panel]

# Tech tracking
tech-stack:
  added: []
  patterns: [admin entailment config page with SPARQL ontology queries for examples, inference cleanup on model uninstall]
