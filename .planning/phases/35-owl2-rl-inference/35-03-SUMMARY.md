...
plan: 03
subsystem: ui
tags: [owl2-rl, inference, htmx, bottom-panel, css, jinja2]

# Dependency graph
requires:
  - phase: 35-01
    provides: InferenceService API endpoints (run, list, dismiss, promote)
  - phase: 35-02
    provides: Inferred badge CSS, dual-graph display patterns
provides:
...
affects: [35-04-PLAN, admin-panel, user-workflow]

# Tech tracking
tech-stack:
  added: []
  patterns: [bottom-panel tab pattern for inference, htmx-driven triple management, hover-reveal action buttons]
