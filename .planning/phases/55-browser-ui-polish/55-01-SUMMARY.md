...
plan: 01
subsystem: ui
tags: [htmx, lucide, ninja-keys, command-palette, nav-tree]
...
tech-stack:
  added: []
  patterns:
    - "Explorer header hover-reveal pattern (opacity transition on hover)"
    - "Per-type command palette entries extracted from DOM (nav tree)"
...
requirements-completed: [OBUI-01, OBUI-02]
