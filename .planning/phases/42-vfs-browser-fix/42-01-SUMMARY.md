...
plan: 01
subsystem: browser
tags: [vfs, htmx, sparql, label-service]

requires:
  - phase: 41-gap-closure
    provides: "VFS browser tab initial implementation"
provides:
...
key-decisions:
  - "No new decisions -- all three fixes were straightforward single-line edits"
