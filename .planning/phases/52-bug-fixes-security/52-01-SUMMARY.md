...
plan: 01
subsystem: ui, events
tags: [css-flexbox, jinja2, compound-events, compensating-events, rdf-undo]
...
affects: [event-log, lint-dashboard, browser-router]

# Tech tracking
tech-stack:
  added: []
  patterns:
    - "Compound event detection via comma-in-string check in Jinja2 templates"
    - "Compensating event pattern extended to object.create (materialize_deletes only)"
