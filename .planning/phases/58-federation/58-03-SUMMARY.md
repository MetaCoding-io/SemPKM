...
plan: 03
subsystem: api
tags: [federation, shared-graphs, sync, ldn, sparql-scoping, rdf-metadata]

# Dependency graph
requires:
  - phase: 58-federation
    provides: RDF Patch serialization, EventStore graph targeting and syncSource, HTTP Signatures, WebFinger, LDN inbox
provides:
...
tech-stack:
  added: []
  patterns: [Federation metadata in RDF named graph, fire-and-forget LDN alerts, SPARQL shared graph scoping]
...
requirements-completed: [FED-03, FED-04, FED-07]
