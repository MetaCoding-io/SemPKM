...
IndieAuth clients discover your authorization and token endpoints automatically. Your WebID profile page (see [Chapter 49: WebID Profiles](49-webid-profiles.md)) includes:
...
2. Ensure your WebID profile is published (see [Chapter 49](49-webid-profiles.md))
...
- [Chapter 49: WebID Profiles](49-webid-profiles.md) -- set up the profile that IndieAuth uses for identity
- [Chapter 15: Settings](15-settings.md) -- manage identity settings and authorized apps
- [Appendix A: Environment Variable Reference](appendix-a-environment-variables.md) -- configure `APP_BASE_URL`

---

**Previous:** [Chapter 49: WebID Profiles](49-webid-profiles.md) | **Next:** [Chapter 51: Federation and Shared Graphs](51-federation.md)
