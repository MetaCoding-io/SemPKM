...
The API surface is distinct from the [Command API](18-command-api.md) (which
handles writes) and the [SPARQL endpoint](19-sparql-endpoint.md) (which handles
...
**Previous:** [Chapter 32: Workspace Personas](32-personas.md) | **Next:** [Chapter 34: Browser Extension](34-browser-extension.md)
