...
The API surface is distinct from the [Command API](19-command-api.md) (which
handles writes) and the [SPARQL endpoint](20-sparql-endpoint.md) (which handles
...
**Previous:** [Chapter 33: Workspace Personas](33-personas.md) | **Next:** [Chapter 35: Browser Extension](35-browser-extension.md)
