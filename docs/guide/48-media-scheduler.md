...
If you have not yet installed the App Platform itself, see [Chapter 31: App Platform](31-app-platform.md) first.
...
The Media Scheduler integrates with the SemPKM mobile context system (see [Chapter 47: Mobile App & Context](47-mobile-app-context.md)) to provide context-aware suggestions.
...
- See [Chapter 47: Mobile App & Context](47-mobile-app-context.md) for mobile-side troubleshooting.

---

## See Also

- [Chapter 31: App Platform](31-app-platform.md) — how the app platform manages apps, lifecycle, and permissions
- [Chapter 10: Managing Mental Models](10-managing-mental-models.md) — installing and managing the `media-scheduler` model
- [Chapter 47: Mobile App & Context](47-mobile-app-context.md) — mobile context integration

---

**Previous:** [Chapter 47: Mobile App & Context](47-mobile-app-context.md) | **Next:** [Chapter 49: WebID Profiles](49-webid-profiles.md)
