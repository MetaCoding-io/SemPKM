...
3. **Browser extension installed and connected.** The AI features are accessed through the extension sidebar. See [Chapter 34: Browser Extension](34-browser-extension.md) for installation and connection instructions.
...
- [Chapter 34: Browser Extension](34-browser-extension.md) — extension installation and connection setup
- [Appendix A: Environment Variable Reference](appendix-a-environment-variables.md) — LLM configuration environment variables

---

**Previous:** [Chapter 35: Context Overlay](35-context-overlay.md) | **Next:** [Chapter 37: Linear Sync](37-linear-sync.md)
