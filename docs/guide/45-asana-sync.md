...
If installation fails, check that the path is correct and the directory contains a valid `manifest.yaml`. See [Chapter 30: App Platform](30-app-platform.md) for troubleshooting app installation.
...
- [Chapter 30: App Platform](30-app-platform.md) — managing apps, installation, monitoring
...
**Previous:** [Chapter 44: CalDAV Calendar Sync](44-caldav-calendar-sync.md) | **Next:** [Chapter 46: Mobile App & Context](46-mobile-app-context.md)
