...
- [Chapter 27: Obsidian Onboarding](27-obsidian-onboarding.md) — import from Obsidian instead of Notion
- [Appendix A: Environment Variable Reference](appendix-a-environment-variables.md) — configuration options

---

**Previous:** [Chapter 27: Obsidian Import](27-obsidian-onboarding.md) | **Next:** [Chapter 29: Spatial Canvas](29-spatial-canvas.md)
