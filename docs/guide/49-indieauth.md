...
IndieAuth clients discover your authorization and token endpoints automatically. Your WebID profile page (see [Chapter 48: WebID Profiles](48-webid-profiles.md)) includes:
...
2. Ensure your WebID profile is published (see [Chapter 48](48-webid-profiles.md))
...
- [Chapter 48: WebID Profiles](48-webid-profiles.md) -- set up the profile that IndieAuth uses for identity
- [Chapter 14: Settings](14-settings.md) -- manage identity settings and authorized apps
- [Appendix A: Environment Variable Reference](appendix-a-environment-variables.md) -- configure `APP_BASE_URL`

---

**Previous:** [Chapter 48: WebID Profiles](48-webid-profiles.md) | **Next:** [Chapter 50: Federation and Shared Graphs](50-federation.md)
