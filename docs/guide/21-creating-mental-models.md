# Chapter 21: Creating Mental Models
...
`rules` points at a SHACL-AF Turtle file (inference rules and validation constraints). `dashboards` and `workflows` are JSON files that v2 manifests use to ship dashboards and guided workflows (see [Chapter 30](30-dashboards-and-workflows.md)). `docs` is described in the next section.
...
**Previous:** [Chapter 20: The SPARQL Endpoint](20-sparql-endpoint.md) | **Next:** [Chapter 22: Production Deployment](22-production-deployment.md)
