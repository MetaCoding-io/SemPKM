# Chapter 15: System Health and Debugging
...
The Event Log is a built-in panel in the workspace that shows a chronological record of every data change in your SemPKM instance. While it is covered in depth in [Understanding the Event Log](16-event-log.md), it is also a critical debugging tool.
...
The Lint Dashboard gives you a bird's-eye view of every SHACL validation issue across your entire knowledge base. While the per-object Lint panel (see [Chapter 17: The Data Model](17-data-model.md)) shows violations for a single object, the Global Lint Dashboard aggregates all violations, warnings, and informational messages into one filterable table.
...
**Previous:** [Chapter 14: Settings](14-settings.md) | **Next:** [Chapter 16: Understanding the Event Log](16-event-log.md)
