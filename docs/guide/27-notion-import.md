...
- [Chapter 26: Obsidian Onboarding](26-obsidian-onboarding.md) — import from Obsidian instead of Notion
- [Appendix A: Environment Variable Reference](appendix-a-environment-variables.md) — configuration options

---

**Previous:** [Chapter 26: Obsidian Import](26-obsidian-onboarding.md) | **Next:** [Chapter 28: Spatial Canvas](28-spatial-canvas.md)
