...
> **Tip:** For production deployments behind HTTPS, you should configure the Secure flag to `true` to prevent the cookie from being transmitted over unencrypted connections. See [Production Deployment](21-production-deployment.md) for details.

---

**Previous:** [Chapter 11: Mental Model Catalog](11-mental-model-catalog.md) | **Next:** [Chapter 13: Webhooks](13-webhooks.md)
