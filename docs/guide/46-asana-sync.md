...
If installation fails, check that the path is correct and the directory contains a valid `manifest.yaml`. See [Chapter 31: App Platform](31-app-platform.md) for troubleshooting app installation.
...
- [Chapter 31: App Platform](31-app-platform.md) — managing apps, installation, monitoring
- [Chapter 10: Managing Mental Models](10-managing-mental-models.md) — installing Basic PKM (required for Task type)
- [Chapter 43: Todoist Sync](43-todoist-sync.md) — another task sync app for comparison

---

**Previous:** [Chapter 45: CalDAV Calendar Sync](45-caldav-calendar-sync.md) | **Next:** [Chapter 47: Mobile App & Context](47-mobile-app-context.md)
