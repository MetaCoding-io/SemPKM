# Chapter 20: The SPARQL Endpoint
...
[The Command API](19-command-api.md) for how to obtain a session for scripting.
...
This is intentional: all writes must go through the [Command API](19-command-api.md)
...
**Previous:** [Chapter 19: The Command API](19-command-api.md) | **Next:** [Chapter 21: Creating Mental Models](21-creating-mental-models.md)
