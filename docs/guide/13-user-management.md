...
> **Tip:** For production deployments behind HTTPS, you should configure the Secure flag to `true` to prevent the cookie from being transmitted over unencrypted connections. See [Production Deployment](22-production-deployment.md) for details.

---

**Previous:** [Chapter 12: PPV Model (Pillars, Pipelines & Vaults)](12-ppv-model.md) | **Next:** [Chapter 14: Webhooks](14-webhooks.md)
