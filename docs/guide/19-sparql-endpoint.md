# Chapter 19: The SPARQL Endpoint
...
[The Command API](18-command-api.md) for how to obtain a session for scripting.
...
This is intentional: all writes must go through the [Command API](18-command-api.md)
...
**Previous:** [Chapter 18: The Command API](18-command-api.md) | **Next:** [Chapter 20: Creating Mental Models](20-creating-mental-models.md)
