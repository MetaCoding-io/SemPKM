...
For a complete walkthrough, see [Chapter 26: Obsidian Onboarding](26-obsidian-onboarding.md).
...
See [Chapter 20: Creating Mental Models](20-creating-mental-models.md) for a complete walkthrough with examples.
...
See [Chapter 48: WebID Profiles](48-webid-profiles.md) for details.
...
This requires `APP_BASE_URL` to be set to a publicly accessible URL. See [Chapter 49: IndieAuth](49-indieauth.md) for a complete walkthrough.
...
See the "Backup and Restore" section in [Chapter 21: Production Deployment](21-production-deployment.md). In short:
