...
If you have not yet installed the App Platform itself, see [Chapter 30: App Platform](30-app-platform.md) first.
...
The Media Scheduler integrates with the SemPKM mobile context system (see [Chapter 46: Mobile App & Context](46-mobile-app-context.md)) to provide context-aware suggestions.
...
- See [Chapter 46: Mobile App & Context](46-mobile-app-context.md) for mobile-side troubleshooting.

---

## See Also

- [Chapter 30: App Platform](30-app-platform.md) — how the app platform manages apps, lifecycle, and permissions
- [Chapter 10: Managing Mental Models](10-managing-mental-models.md) — installing and managing the `media-scheduler` model
- [Chapter 46: Mobile App & Context](46-mobile-app-context.md) — mobile context integration

---

**Previous:** [Chapter 46: Mobile App & Context](46-mobile-app-context.md) | **Next:** [Chapter 48: WebID Profiles](48-webid-profiles.md)
