# Chapter 16: System Health and Debugging
...
The Event Log is a built-in panel in the workspace that shows a chronological record of every data change in your SemPKM instance. While it is covered in depth in [Understanding the Event Log](17-event-log.md), it is also a critical debugging tool.
...
The Lint Dashboard gives you a bird's-eye view of every SHACL validation issue across your entire knowledge base. While the per-object Lint panel (see [Chapter 18: The Data Model](18-data-model.md)) shows violations for a single object, the Global Lint Dashboard aggregates all violations, warnings, and informational messages into one filterable table.
...
**Previous:** [Chapter 15: Settings](15-settings.md) | **Next:** [Chapter 17: Understanding the Event Log](17-event-log.md)
