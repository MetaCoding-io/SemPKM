...
3. **Browser extension installed and connected.** The AI features are accessed through the extension sidebar. See [Chapter 35: Browser Extension](35-browser-extension.md) for installation and connection instructions.
...
- [Chapter 35: Browser Extension](35-browser-extension.md) — extension installation and connection setup
- [Appendix A: Environment Variable Reference](appendix-a-environment-variables.md) — LLM configuration environment variables

---

**Previous:** [Chapter 36: Context Overlay](36-context-overlay.md) | **Next:** [Chapter 38: Linear Sync](38-linear-sync.md)
